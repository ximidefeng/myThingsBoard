...
public class JpaDeviceDao extends JpaAbstractSearchTextDao<DeviceEntity, Device> implements DeviceDao {
    ...
    @Override
    public PageData<Device> findDevicesByTenantIdAndCustomerIds(UUID tenantId, List<UUID> customerIds, PageLink pageLink) {
        return DaoUtil.toPageData(
                deviceRepository.findByTenantIdAndCustomerIdS(
                        tenantId,
                        customerIds,
                        Objects.toString(pageLink.getTextSearch(), ""),
                        DaoUtil.toPageable(pageLink)));
    ...
    @Override
    public PageData<DeviceInfo> findDeviceInfosByTenantIdAndCustomerIds(UUID tenantId, List<UUID> customerIds, PageLink pageLink) {
        return DaoUtil.toPageData(
                deviceRepository.findDeviceInfosByTenantIdAndCustomerIds(
                        tenantId,
                        customerIds,
                        Objects.toString(pageLink.getTextSearch(), ""),
                        DaoUtil.toPageable(pageLink, DeviceInfoEntity.deviceInfoColumnMap)));
