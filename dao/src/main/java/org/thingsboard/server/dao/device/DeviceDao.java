...
public interface DeviceDao extends Dao<Device>, TenantEntityDao, ExportableEntityDao<DeviceId, Device> {
    ...
    /**
     * Find devices by tenantId, customerIds and page link.
     *
     * @param tenantId the tenantId
     ...
     * @return the list of device objects
     */
    PageData<Device> findDevicesByTenantIdAndCustomerIds(UUID tenantId, List<UUID> customerIds, PageLink pageLink);
    ...
    /**
     * Find device infos by tenantId, customerIds and page link.
     *
     * @param tenantId the tenantId
     * @param customerIds the customerIds
     * @param pageLink the page link
     * @return the list of device info objects
     */
    PageData<DeviceInfo> findDeviceInfosByTenantIdAndCustomerIds(UUID tenantId, List<UUID> customerIds, PageLink pageLink);
