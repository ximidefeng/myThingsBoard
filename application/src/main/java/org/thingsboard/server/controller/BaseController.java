...
public abstract class BaseController {
        ...
        try {
            ...
            switch (entityId.getEntityType()) {
                ...
                case ASSET_PROFILE:
                    ...
                    return;
                case DASHBOARD:
                    checkDashboardId(new DashboardId(entityId.getId()), operation, false);
                    return;
                case USER:
    ...
    Device checkDeviceId(DeviceId deviceId, Operation operation) throws ThingsboardException {
        try {
            ...
            if(device.getCustomerId().equals(customerId)){
                ...
                // 不是当前用户
                // 那就去关系表中查询是否是下属用户
                List<EntityRelationInfo> entityRelationInfos = findAgentRelationsByCustomerId(getCurrentUser().getTenantId(), customerId);
    ...
    Dashboard checkDashboardId(DashboardId dashboardId, Operation operation, boolean temp) throws ThingsboardException {
        try {
